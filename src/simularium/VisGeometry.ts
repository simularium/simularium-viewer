...
class VisGeometry {
    ...
    private pathEndColor: Color;
    private visGeomMap: Map<number, AgentTypeGeometry>;
    private meshRegistry: Map<string | number, Mesh>;
    private pdbRegistry: Map<string | number, PDBModel>;
    private meshLoadAttempted: Map<string, boolean>;
    private pdbLoadAttempted: Map<string, boolean>;
    private scaleMapping: Map<number, number>;
    private geomCount: number;
    private followObjectIndex: number;
    private visAgents: VisAgent[];
    private runTimeFiberMeshes: Map<string, Mesh>;
    private mlastNumberOfAgents: number;
    private colorVariant: number;
    private fixLightsToCamera: boolean;
    private highlightedId: number;
    private paths: PathData[];
    private mlogger: ILogger;
    private renderer: WebGLRenderer;
    private scene: Scene;
    private camera: PerspectiveCamera;
    private controls: OrbitControls;
    private dl: DirectionalLight;
    private boundingBox: Box3;
    private boundingBoxMesh: Box3Helper;
    private hemiLight: HemisphereLight;
    private moleculeRenderer: MoleculeRenderer;
    private currentSceneAgents: AgentData[];
    private colorsData: Float32Array;
    private lightsGroup: Group;
    private agentMeshGroup: Group;
    private agentFiberGroup: Group;
    private agentPDBGroup: Group;
    private agentPathGroup: Group;
