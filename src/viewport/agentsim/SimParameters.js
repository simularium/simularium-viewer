class SimParameters {
  constructor() {
    ...
    this.timeStepSliderVal = 0;
    this.lastTimeStepSliderVal = 0;

    this.minimumTimeStep = 0.001;
    this.maximumTimeStep = 1;
    this.timeStepSliderExponent = 4;

    this.preRunNumTimeSteps = 1000;
    this.preRunTimeStep = 1e-5;

    this.trajectoryPlaybackFile = '';
    this.cachePlaybackFrame = 0;
