...
describe("util", function () {
  describe("compareTimes", function () {
    ...
    test("it correctly determines time1 > time2", function () {
      var result = (0, _util.compareTimes)(14.699999809265137, 14.6, PRECISION_REF);
      expect(result).toEqual(1);
    });
    test("it correctly determines time1 < time2", function () {
      var result = (0, _util.compareTimes)(14.600000381469727, 14.699999809265137, PRECISION_REF);
      expect(result).toEqual(-1);
    });
    test("it correctly determines time1 ~= time2 when time1 is slightly greater", function () {
      var result = (0, _util.compareTimes)(14.700000190734863, 14.699999809265137, PRECISION_REF);
      expect(result).toEqual(0);
    });
    test("it correctly determines time1 ~= time2 when time1 is slightly less", function () {
      var result = (0, _util.compareTimes)(14.699999809265137, 14.7, PRECISION_REF);
      expect(result).toEqual(0);
    });
    test("it correctly determines time1 ~= time2 when numbers are equal", function () {
      var result = (0, _util.compareTimes)(0.005, 0.005, 0.005);
      expect(result).toEqual(0);
    });
  });
