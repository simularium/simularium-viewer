...
var _TaskQueue = require("../simularium/TaskQueue");
...
describe("TaskQueue module", function () {
  ...
  test("it resolves tasks that finish synchronously", function () {
    ...
    var q = new _TaskQueue.TaskQueue();
  ...
  test("it resolves all delayed tasks", /*#__PURE__*/(0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee() {
  ...
  test("it handles the case when some tasks reject", /*#__PURE__*/(0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2() {
  ...
  test("it handles the case when some delayed tasks reject", /*#__PURE__*/(0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee3() {
  ...
  test("it handles the case when some tasks throw", /*#__PURE__*/(0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee4() {
  ...
  test("it can run tasks that resolve over time", /*#__PURE__*/(0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee5() {
  ...
  test("it can cancel tasks not already started", /*#__PURE__*/(0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee6() {
    var q, p0, p1, p2, p3, p4, p5;
        ...
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            p4.then(null, function (error) {
              expect(error).toBe(_TaskQueue.REASON_CANCELLED);
            });
  ...
  test("it can queue new tasks after cancelling", /*#__PURE__*/(0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee7() {
