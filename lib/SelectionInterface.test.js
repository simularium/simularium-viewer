...
describe("SelectionInterface module", function () {
  describe("decode", function () {
    test("Can decode valid encoded input", function () {
      ...
      var si = new _simularium.SelectionInterface();
  ...
  describe("getColorsForName", function () {
    ...
    test("it returns an array of colors if they are given", function () {
      var si = new _simularium.SelectionInterface();
      var color = "#aaaaaa";
      var idMappingWithColors = (0, _lodash.mapValues)(idMapping, function (entry) {
  ...
  describe("setAgentColors", function () {
    ...
    var idMappingWithColors = (0, _lodash.mapValues)(newIdMapping, function (entry) {
      return _objectSpread(_objectSpread({}, entry), {}, {
        geometry: {
          url: "",
          displayType: "",
    ...
    beforeEach(function () {
      si = new _simularium.SelectionInterface();
      si.parse(idMappingWithColors);
