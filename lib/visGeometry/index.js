...
exports["default"] = exports.VisGeometry = exports.RenderStyle = exports.NO_AGENT = void 0;
...
var _WebGL = _interopRequireDefault(require("three/examples/jsm/capabilities/WebGL.js"));
...
var EssentialsPlugin = _interopRequireWildcard(require("@tweakpane/plugin-essentials"));
...
var _VisTypes = _interopRequireDefault(require("../simularium/VisTypes"));

var _agentPath = _interopRequireDefault(require("./agentPath"));
...
var VisGeometry = /*#__PURE__*/function () {
  ...
  function VisGeometry(loggerLevel) {
    ...
    (0, _defineProperty2["default"])(this, "agentPaths", void 0);
    ...
    (0, _defineProperty2["default"])(this, "gui", void 0);
    (0, _defineProperty2["default"])(this, "cam1", void 0);
    (0, _defineProperty2["default"])(this, "cam2", void 0);
    (0, _defineProperty2["default"])(this, "cam3", void 0);
    (0, _defineProperty2["default"])(this, "agentsWithPdbsToDraw", void 0);
    (0, _defineProperty2["default"])(this, "agentPdbsToDraw", void 0);
    this.cam1 = (0, _lodash.cloneDeep)(_constants.DEFAULT_CAMERA_SPEC);
    this.cam2 = (0, _lodash.cloneDeep)(_constants.DEFAULT_CAMERA_SPEC);
    this.cam3 = (0, _lodash.cloneDeep)(_constants.DEFAULT_CAMERA_SPEC);
    ...
    this.camera = new _three.PerspectiveCamera(75, 100 / 100, CAMERA_INITIAL_ZNEAR, CAMERA_INITIAL_ZFAR);
  ...
  (0, _createClass2["default"])(VisGeometry, [{
    ...
    value: function setupGui(container) {
      ...
      this.gui.addButton({
        ...
        fileinput.addEventListener("change", function (e) {
          ...
          reader.onload = function (event) {
            ...
            var cam = (0, _lodash.cloneDeep)(_constants.DEFAULT_CAMERA_SPEC);
      ...
      this.gui.addInput(settings, "lodBias", {
        min: 0,
        max: 4,
        step: 1
    ...
    value: function getAllTypeIdsForGeometryName(name) {
      return (0, _toConsumableArray2["default"])(this.visGeomMap.entries()).filter(function (_ref2) {
        var v = _ref2[1];
        return v === name;
      }).map(function (_ref3) {
    ...
    value: function setupScene() {
      ...
      this.camera = new _three.PerspectiveCamera(75, initWidth / initHeight, CAMERA_INITIAL_ZNEAR, CAMERA_INITIAL_ZFAR);
      ...
      if (_WebGL["default"].isWebGL2Available() === false) {
        this.renderStyle = RenderStyle.WEBGL1_FALLBACK;
        this.supportsWebGL2Rendering = false;
        this.threejsrenderer = new _three.WebGLRenderer({
          premultipliedAlpha: false
    ...
    value: function setColorForIds(ids, colorId) {
      ...
      if (this.isIdColorMappingSet) {
        throw new _FrontEndError.FrontEndError("Attempted to set agent-color after color mapping was finalized");
      }
    ...
    value: function setGeometryData(typeMapping) {
      ...
      Object.keys(typeMapping).forEach(function (id) {
        ...
        _this6.geometryStore.mapKeyToGeom(Number(id), entry.geometry).then(function (newGeometryLoaded) {
          ...
          if (errorMessage) {
            _this6.onError(new _FrontEndError.FrontEndError(errorMessage, _FrontEndError.ErrorLevel.WARNING));

            _this6.logger.info(errorMessage);
          }
        })["catch"](function (reason) {
          _this6.onError(new _FrontEndError.FrontEndError(reason));
    ...
    value: function resetBounds(volumeDimensions) {
      ...
      var _volumeDimensions = volumeDimensions,
          _volumeDimensions2 = (0, _slicedToArray2["default"])(_volumeDimensions, 3),
    ...
    value: function addPathForAgent(id, maxSegments, color) {
      ...
      var pathdata = new _agentPath["default"](color, maxSegments);
