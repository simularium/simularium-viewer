...
var FOLLOW_COLOR = new _three.Color(0xffff00);
var HIGHLIGHT_COLOR = new _three.Color(0xffffff); // data and functions for rendering in the low fidelity webgl1 mode

var LegacyRenderer = /*#__PURE__*/function () {
  function LegacyRenderer() {
    (0, _classCallCheck2["default"])(this, LegacyRenderer);
    (0, _defineProperty2["default"])(this, "baseMaterial", void 0);
    (0, _defineProperty2["default"])(this, "highlightMaterial", void 0);
    (0, _defineProperty2["default"])(this, "followMaterial", void 0);
    (0, _defineProperty2["default"])(this, "agentMeshGroup", void 0);
    this.baseMaterial = new _three.MeshLambertMaterial({
      color: new _three.Color(0xff00ff)
    });
    this.highlightMaterial = new _three.MeshBasicMaterial({
      color: new _three.Color(HIGHLIGHT_COLOR),
      transparent: true,
      opacity: 0.6
    });
    this.followMaterial = new _three.MeshBasicMaterial({
      color: new _three.Color(FOLLOW_COLOR)
    });
    this.agentMeshGroup = new _three.Group();
  }

  (0, _createClass2["default"])(LegacyRenderer, [{
    key: "beginUpdate",
    ...
    value: function addFiber(visAgent, scale, color) {
      ...
      var fibergeometry = new _three.TubeBufferGeometry(visAgent.fiberCurve, 4 * (visAgent.fiberCurve.points.length - 1), // 4 segments per control point
      scale * 0.5, 8, // could reduce this with depth?
      false);
      var m = new _three.Mesh(fibergeometry, this.selectMaterial(visAgent, color));
      m.userData = {
    ...
    value: function addMesh(meshGeom, visAgent, scale, color) {
      var m = new _three.Mesh(meshGeom, this.selectMaterial(visAgent, color));
    ...
    value: function addPdb(pdb, visAgent, color, distances) {
      ...
      for (var lod = pdbObjects.length - 1; lod >= 0; --lod) {
        ...
        obj.material = new _three.PointsMaterial({
