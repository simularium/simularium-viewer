...
var _TaskQueue = _interopRequireDefault(require("../simularium/TaskQueue"));

var _types = require("./types");

var _MetaballMesh = require("./rendering/MetaballMesh");
...
var GeometryStore = /*#__PURE__*/function () {
  ...
  function GeometryStore(loggerLevel) {
    ...
    this._registry.set(DEFAULT_MESH_NAME, {
      ...
      geometry: {
        mesh: new _three.Mesh(GeometryStore.sphereGeometry),
        cancelled: false,
        instances: new _InstancedMesh.InstancedMesh(_InstancedMesh.InstanceType.MESH, GeometryStore.sphereGeometry, DEFAULT_MESH_NAME, 1)
      }
    });
  ...
  (0, _createClass2["default"])(GeometryStore, [{
    ...
    value: function createNewSphereGeometry(meshName) {
      ...
      return {
        mesh: new _three.Mesh(GeometryStore.sphereGeometry),
        cancelled: false,
        instances: new _InstancedMesh.InstancedMesh(_InstancedMesh.InstanceType.MESH, GeometryStore.sphereGeometry, meshName, 1)
      };
    }
  }, {
    ...
    value: function createNewCubeGeometry(meshName) {
      return {
        mesh: new _three.Mesh(GeometryStore.cubeGeometry),
        cancelled: false,
        instances: new _InstancedMesh.InstancedMesh(_InstancedMesh.InstanceType.MESH, GeometryStore.cubeGeometry, meshName, 1)
      };
    }
  }, {
    ...
    value: function prepMeshRegistryForNewObj(meshName) {
      ...
      if (this._registry.has(meshName)) {
        ...
        if (geometry && displayType !== _types.GeometryDisplayType.PDB && displayType !== _types.GeometryDisplayType.SPHERE_GROUP) {
          ...
          meshRequest.mesh = new _three.Mesh(GeometryStore.sphereGeometry);
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                if (displayType === _types.GeometryDisplayType.SPHERE_GROUP) {
                  ...
                  geometry = {
                    mesh: null,
                    cancelled: false,
                    instances: new _MetaballMesh.MetaballMesh(lookupKey)
                  };
                  this.setGeometryInRegistry(lookupKey, geometry, displayType);
                } else if (displayType === _types.GeometryDisplayType.CUBE) {
                  geometry = this.createNewCubeGeometry(lookupKey);
                  this.setGeometryInRegistry(lookupKey, geometry, _types.GeometryDisplayType.CUBE);
                } else {
                  // default to a sphere
                  geometry = this.createNewSphereGeometry(lookupKey);
                  this.setGeometryInRegistry(lookupKey, geometry, _types.GeometryDisplayType.SPHERE);
                }
              ...
              case 8:
                ...
                _lookupKey = (0, _util.checkAndSanitizePath)(url);
                return _context.abrupt("return", this.attemptToLoadGeometry(_lookupKey, displayType).then(function (geometry) {
                  ...
                  _this4.setGeometryInRegistry(_lookupKey, geometry, _types.GeometryDisplayType.SPHERE);
...
(0, _defineProperty2["default"])(GeometryStore, "sphereGeometry", new _three.SphereBufferGeometry(1, 32, 32));
(0, _defineProperty2["default"])(GeometryStore, "cubeGeometry", new _three.BoxBufferGeometry(1, 1, 1));
(0, _defineProperty2["default"])(GeometryStore, "shouldLoadPrimitive", function (displayType, url) {
  if (!url) {
  ...
  if (displayType === _types.GeometryDisplayType.PDB || displayType === _types.GeometryDisplayType.OBJ) {
    return false;
  }
