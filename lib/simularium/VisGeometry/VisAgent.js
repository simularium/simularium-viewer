...
var VisAgent = /*#__PURE__*/function () {
  function VisAgent(name) {
    (0, _classCallCheck2["default"])(this, VisAgent);
    (0, _defineProperty2["default"])(this, "agentData", void 0);
    (0, _defineProperty2["default"])(this, "fiberCurve", void 0);
    (0, _defineProperty2["default"])(this, "colorIndex", void 0);
    (0, _defineProperty2["default"])(this, "active", void 0);
    (0, _defineProperty2["default"])(this, "color", void 0);
    (0, _defineProperty2["default"])(this, "name", void 0);
    (0, _defineProperty2["default"])(this, "followed", void 0);
    (0, _defineProperty2["default"])(this, "highlighted", void 0);
    ...
    this.agentData = {
      ...
      zrot: 0,
      instanceId: NO_AGENT,
      visType: _VisTypes["default"].ID_VIS_TYPE_DEFAULT,
      type: 0,
      cr: 1.0,
      subpoints: []
    };
  ...
  (0, _createClass2["default"])(VisAgent, [{
    key: "resetMesh",
    ...
    value: function getFollowPosition() {
      if (this.agentData.visType === _VisTypes["default"].ID_VIS_TYPE_FIBER && this.fiberCurve) {
        return this.fiberCurve.getPoint(0.5);
      } else {
        return new _three.Vector3(this.agentData.x, this.agentData.y, this.agentData.z);
      }
    }
  }]);
  return VisAgent;
...
(0, _defineProperty2["default"])(VisAgent, "UNASSIGNED_MESH_COLOR", 0xff00ff);
(0, _defineProperty2["default"])(VisAgent, "UNASSIGNED_NAME_PREFIX", "Unassigned");
(0, _defineProperty2["default"])(VisAgent, "sphereGeometry", new _three.SphereBufferGeometry(1, 32, 32));