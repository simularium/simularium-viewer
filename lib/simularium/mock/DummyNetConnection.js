...
exports.DummyNetConnection = void 0;

var _ = require("../");

var _NetConnection2 = require("../NetConnection");
...
var DummyNetConnection = /*#__PURE__*/function (_NetConnection) {
  _inherits(DummyNetConnection, _NetConnection);

  var _super = _createSuper(DummyNetConnection);
  ...
  _createClass(DummyNetConnection, [{
    ...
    value: function getDataBundle(frameNumber, bundleSize) {
      var msg = {
        msgType: _NetConnection2.NetMessageEnum.ID_VIS_DATA_ARRIVE,
    ...
    value: function requestTrajectoryFileInfo(fileName) {
      ...
      setTimeout(function () {
        var tfi = {
          msgType: _NetConnection2.NetMessageEnum.ID_TRAJECTORY_FILE_INFO,
          boxSizeX: 100,
          boxSizeY: 100,
          boxSizeZ: 20,
...
exports.DummyNetConnection = DummyNetConnection;