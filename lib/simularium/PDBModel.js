...
var _KMeansWorker = _interopRequireDefault(require("./worker/KMeansWorker"));
  ...
  _createClass(PDBModel, [{
    ...
    value: function download(url) {
      ...
      return fetch(pdbRequest).then(function (response) {
        ...
        if (_this.cancelled) {
          return Promise.reject(_TaskQueue.REASON_CANCELLED);
        } // note pdb atom coordinates are in angstroms
        // 1 nm is 10 angstroms


        _this.pdb = (0, _parsePdb.default)(data);
        ...
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                worker = new _KMeansWorker.default();
