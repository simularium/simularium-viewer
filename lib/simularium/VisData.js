...
exports["default"] = exports.VisData = void 0;
...
var util = _interopRequireWildcard(require("./ThreadUtil"));
...
var VisData = /*#__PURE__*/function () {
  function VisData() {
    (0, _classCallCheck2["default"])(this, VisData);
    (0, _defineProperty2["default"])(this, "frameCache", void 0);
    (0, _defineProperty2["default"])(this, "frameDataCache", void 0);
    (0, _defineProperty2["default"])(this, "webWorker", void 0);
    (0, _defineProperty2["default"])(this, "frameToWaitFor", void 0);
    (0, _defineProperty2["default"])(this, "lockedForFrame", void 0);
    (0, _defineProperty2["default"])(this, "cacheFrame", void 0);
    (0, _defineProperty2["default"])(this, "netBuffer", void 0);
    (0, _defineProperty2["default"])(this, "_dragAndDropFileInfo", void 0);
    (0, _defineProperty2["default"])(this, "firstFrameTime", void 0);
    (0, _defineProperty2["default"])(this, "timeStepSize", void 0);
    this.webWorker = null;
  ...
  (0, _createClass2["default"])(VisData, [{
    key: "setupWebWorker",
    ...
    value: function hasLocalCacheForTime(time) {
      ...
      var notLessThanFirstFrameTime = (0, _util.compareTimes)(time, firstFrameTime, this.timeStepSize) !== -1;
      var notGreaterThanLastFrameTime = (0, _util.compareTimes)(time, lastFrameTime, this.timeStepSize) !== 1;
    ...
    value: function gotoTime(time) {
      ...
      var frameNumber = this.frameDataCache.findIndex(function (frameData) {
        return (0, _util.compareTimes)(frameData.time, time, _this2.timeStepSize) === 0;
    ...
    value: function checkTypeMapping(typeMappingFromFile) {
      ...
      var idsArr = (0, _toConsumableArray2["default"])(idsInFrameData).sort();
      return (0, _lodash.difference)(idsArr, idsInTypeMapping).sort();
    }
  }, {
      ...
      visDataMsg.bundleData.forEach(function (frame) {
        ...
        var _loop = function _loop() {
          ...
          if (visData.length < chunkLength) {
            ...
            throw new _FrontEndError.FrontEndError("Your data is malformed, there are too few entries.", _FrontEndError.ErrorLevel.ERROR, "Example attempt to parse your data: <pre>".concat(attemptedMapping.join(""), "</pre>"));
          }
          ...
          if (agentSubSetArray.length < AGENT_OBJECT_KEYS.length) {
            ...
            throw new _FrontEndError.FrontEndError("Your data is malformed, there are less entries than expected for this agent. ", _FrontEndError.ErrorLevel.ERROR, "Example attempt to parse your data: <pre>".concat(_attemptedMapping.join(""), "</pre>"));
          }
    ...
    value: function parseOneBinaryFrame(data) {
      ...
      for (var i = 0; i < expectedNumAgents; i++) {
        ...
        if (!Number.isInteger(nSubPoints)) {
          throw new _FrontEndError.FrontEndError("Your data is malformed, non-integer value found for num-subpoints.", _FrontEndError.ErrorLevel.ERROR, "Number of Subpoints: <pre>".concat(nSubPoints, "</pre>"));
          break;
        } // now read sub points.
      ...
      var _loop2 = function _loop2() {
        ...
        var _loop3 = function _loop3() {
          ...
          if (remaining < chunkLength - 1) {
            ...
            throw new _FrontEndError.FrontEndError("Your data is malformed, non-integer value found for num-subpoints.", _FrontEndError.ErrorLevel.ERROR, "Example attempt to parse your data: <pre>".concat(attemptedMapping.join(""), "</pre>"));
          }
          ...
          if (agentSubSetArray.length < AGENT_OBJECT_KEYS.length) {
            ...
            throw new _FrontEndError.FrontEndError("Your data is malformed, there are less entries than expected for this agent.", _FrontEndError.ErrorLevel.ERROR, "Example attempt to parse your data: <pre>".concat(_attemptedMapping2.join(""), "</pre>"));
          }
        ...
        if (numParsedAgents != expectedNumAgents) {
          throw new _FrontEndError.FrontEndError("Mismatch between expected num agents and parsed num agents, possible offset error");
        }
...
exports.VisData = VisData;
var _default = VisData;
