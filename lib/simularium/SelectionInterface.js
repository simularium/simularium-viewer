...
exports["default"] = exports.SelectionInterface = void 0;
...
var _colorUtils = require("../visGeometry/color-utils");

var SelectionInterface = /*#__PURE__*/function () {
  function SelectionInterface() {
    (0, _classCallCheck2["default"])(this, SelectionInterface);
    (0, _defineProperty2["default"])(this, "entries", void 0);
    this.entries = new Map();
  }

  (0, _createClass2["default"])(SelectionInterface, [{
    key: "containsName",
    ...
    value: function decode(encodedName, color, idParam) {
      ...
      var uniqueTags = (0, _toConsumableArray2["default"])(new Set(tags));
      var entry = {
        id: id,
        name: name,
        tags: uniqueTags,
    ...
    value: function getTags(name, id) {
      ...
      var state = (0, _lodash.find)(entryList, function (entry) {
        return entry.id === id;
      });
    ...
    value: function getHighlightedIds(info) {
      ...
      requests.forEach(function (r) {
        var name = r.name;
        var tags = r.tags;
        indices = [].concat((0, _toConsumableArray2["default"])(indices), (0, _toConsumableArray2["default"])(_this3.getIds(name, tags)));
      });
      return indices;
    }
    /*
    ...
    value: function getHiddenIds(info) {
      ...
      requests.forEach(function (r) {
        var name = r.name;
        var tags = r.tags;
        indices = [].concat((0, _toConsumableArray2["default"])(indices), (0, _toConsumableArray2["default"])(_this4.getIds(name, tags)));
      });
      return indices;
    }
  }, {
    ...
    value: function updateUiDataColor(entry, id, color) {
      ...
      entry.displayStates.forEach(function (displayState) {
        if (tagsToUpdate.includes(displayState.id)) {
          displayState.color = (0, _colorUtils.convertColorNumberToString)(color);
        }
      });
    }
  }, {
    ...
    value: function setAgentColors(uiDisplayData, colors, setColorForIds) {
      ...
      uiDisplayData.forEach(function (group) {
        ...
        var groupColorIndex = defaultColorIndex; // list of ids that all have this same name

        var ids = _this6.getIds(group.name); // list of colors for this entry, will be empty strings for
        // ids that don't have a user set color


        var newColors = _this6.getColorsForName(group.name);

        var hasNewColors = (0, _lodash.filter)(newColors).length > 0;
        var allTheSameColor = (0, _lodash.uniq)(newColors).length === 1;
          ...
          newColors.forEach(function (color, index) {
            ...
            if (color) {
              ...
              if (agentColorIndex === -1) {
                ...
                colors = [].concat((0, _toConsumableArray2["default"])(colors), [color]);
        ...
        if (groupColorIndex > -1) {
          group.color = (0, _colorUtils.convertColorNumberToString)(colors[groupColorIndex]);
        } else {
          group.color = "";
        ...
        if ((0, _lodash.filter)(newColors).length !== ids.length || groupColorIndex === defaultColorIndex) {
          defaultColorIndex++;
        }
      });
      return colors;
...
exports.SelectionInterface = SelectionInterface;
var _default = SelectionInterface;
