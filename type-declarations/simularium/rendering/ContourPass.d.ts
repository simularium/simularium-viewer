...
declare class ContourPass {
    ...
    render(renderer: WebGLRenderer, target: WebGLRenderTarget | null, colorBuffer: WebGLRenderTarget, instanceIdBuffer: WebGLRenderTarget, normalsBuffer: WebGLRenderTarget): void;
}
