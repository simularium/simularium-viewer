...
declare class InstancedMesh implements GeometryInstanceContainer {
    ...
    addInstance(x: number, y: number, z: number, scale: number, rx: number, ry: number, rz: number, uniqueAgentId: number, typeId: number, lodScale?: number, _subPoints?: number[]): void;
    endUpdate(): void;
}
