...
import { CONNECTION_SUCCESS_MSG, CONNECTION_FAIL_MSG } from "../simularium/RemoteSimulator";
...
describe("RemoteSimulator", function () {
  ...
  describe("createWebSocket", function () {
    test("creates a WebSocket object", function () {
      var simulator = new RemoteSimulator(CONNECTION_SETTINGS);
  ...
  describe("checkConnection", function () {
    var timeout = 1000;
    test("returns true if connection succeeds within allotted time with no retries", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee() {
    ...
    test("returns false if connection does not succeed within allotted time and number of retries", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2() {
      var simulator, isConnected;
    ...
    test("returns true if connection succeeds on the retry", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3() {
  ...
  describe("connectToRemoteServer", function () {
    test("emits a 'connection success' message if connection succeeds", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee4() {
    ...
    test("emits error if connecting to server is unsuccessful", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee5() {
      var simulator;
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 7:
              ...
              expect(_context5.t0).toEqual(new Error(CONNECTION_FAIL_MSG));
  ...
  describe("startRemoteTrajectoryPlayback", function () {
    test("does not throw error if connectToRemoteServer succeeds", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee7() {
      var simulator;
        ...
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              ...
              expect( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee6() {
    ...
    test("throws error emitted by connectToRemoteServer as a FrontEndError if connection fails", /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee8() {
      var simulator;
        ...
        while (1) {
          switch (_context8.prev = _context8.next) {
            ...
            case 7:
              ...
              expect(_context8.t0).toEqual(new FrontEndError("Mock error message"));
