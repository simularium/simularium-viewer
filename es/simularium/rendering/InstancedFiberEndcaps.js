...
import { SphereBufferGeometry, InstancedBufferAttribute, InstancedBufferGeometry, Mesh } from "three";
...
var InstancedFiberEndcaps = /*#__PURE__*/function () {
  ...
  function InstancedFiberEndcaps() {
    ...
    this.positionAttribute = new InstancedBufferAttribute(new Float32Array(), 4, false);
    this.rotationAttribute = new InstancedBufferAttribute(new Float32Array(), 4, false);
    this.instanceAttribute = new InstancedBufferAttribute(new Float32Array(), 2, false);
  ...
  _createClass(InstancedFiberEndcaps, [{
    ...
    value: function reallocate(n) {
      ...
      this.instancedGeometry = new InstancedBufferGeometry().copy(this.endcapGeometry); // install the new geometry into our Mesh object
      ...
      this.instanceAttribute = new InstancedBufferAttribute(newInst, 2, false);
