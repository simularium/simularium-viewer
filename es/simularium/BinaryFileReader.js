...
var BlockTypeEnum = /*#__PURE__*/function (BlockTypeEnum) {
...
var SIGNATURE = "SIMULARIUMBINARY";
...
var BinaryFileReader = /*#__PURE__*/function () {
  ...
  function BinaryFileReader(fileContents) {
    _classCallCheck(this, BinaryFileReader);
    _defineProperty(this, "fileContents", void 0);
    _defineProperty(this, "dataView", void 0);
    _defineProperty(this, "header", void 0);
    _defineProperty(this, "tfi", void 0);
    _defineProperty(this, "plotData", void 0);
    _defineProperty(this, "nFrames", void 0);
    _defineProperty(this, "frameOffsets", void 0);
    _defineProperty(this, "frameLengths", void 0);
    _defineProperty(this, "spatialDataBlock", void 0);
    this.nFrames = 0;
    this.frameOffsets = [];
    this.frameLengths = [];
  ...
  return _createClass(BinaryFileReader, [{
    ...
    value: function getFrameIndexAtTime(time) {
      var timeStepSize = this.tfi.timeStepSize;
      ...
      for (var i = 0; i < this.nFrames; i++) {
        ...
        var frameTime = this.spatialDataBlock.getFloat32(this.frameOffsets[i] + 4, true);
        // check time
    ...
    value: function getFrame(theFrameNumber) {
      ...
      var totalOffset = this.spatialDataBlock.byteOffset + frameOffset;
...
export { BinaryFileReader as default };