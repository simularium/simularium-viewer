...
import { BufferGeometry, Color, Float32BufferAttribute, FrontSide, Matrix4, ShaderMaterial, TextureLoader, Vector2, Points, Scene } from "three"; // strategy:
...
function () {
  ...
  _createClass(MoleculePass, [{
    ...
    value: function createMoleculeBuffer(n) {
      ...
      this.geometry.setAttribute("position", new Float32BufferAttribute(vertices, 4));
      this.geometry.setAttribute("vTypeId", new Float32BufferAttribute(typeIds, 1));
      this.geometry.setAttribute("vInstanceId", new Float32BufferAttribute(instanceIds, 1));
    ...
    value: function resize(width, height) {
      this.colorMaterial.uniforms.iResolution.value = new Vector2(width, height);
      this.normalMaterial.uniforms.iResolution.value = new Vector2(width, height);
      this.positionMaterial.uniforms.iResolution.value = new Vector2(width, height);
    }
  }, {
    key: "render",
