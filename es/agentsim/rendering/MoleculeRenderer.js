...
function () {
  function MoleculeRenderer() {
    ...
    this.gbufferPass = new MoleculePass(1); // radius, threshold, falloff in view space coordinates.

    this.ssao1Pass = new SSAO1Pass(4.5, 150, 150);
    this.ssao2Pass = new SSAO1Pass(4.5, 150, 150); //        this.ssao1Pass = new SSAO1Pass(0.00005, 0.38505, 0.08333);
